            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link p-2 text-center" href="" rel="noopener" disabled>
                        <i class="fas fa-binoculars"></i>&nbspPagina Visualizzata:&nbsp<img src="https://hitwebcounter.com/counter/counter.php?page=7226472&style=0027&nbdigits=4&type=page&initCount=0" title="User Stats" Alt="PHP Hits Count" border="0">
                    </a>
                </li>
            </ul>
